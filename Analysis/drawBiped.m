function [COM] = drawBiped(xi,flag, i, t, out_extra, step_num, phase_num)
    ...
    head = Head_pos_func(xi,params);
    
    %Set up lines to plot
    x_1 = [foot_st(1,4), knee_st(1,4), hip(1,4),head(1,4)];
    y_1 = [foot_st(2,4), knee_st(2,4), hip(2,4),head(2,4)];
